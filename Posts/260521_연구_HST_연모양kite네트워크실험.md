...
- Resistance distance — 사실 이 예제가 가장 빛나는 자리임. effective resistance 의 정의 자체가 병렬 path 가 많을수록 R_eff 가 낮아진다는 것 ($1/R_{\text{eff}} = \sum 1/R_i$). 빨강-주황 사이 스무 갈래 회색점이 정확히 이 효과의 교과서 예제. 그래서 빨강과 주황을 단단히 묶고 보라를 멀리 떨어뜨려 시선 2 를 분명하게 그려냄. 회색점들이 사방에 퍼져 있는 건 회색 20개끼리가 거의 대등한 위치라 MDS 에서 자유도가 남아 흩어진 것으로, 해석이 *틀렸다*기보다는 *남은 자유도를 처리하는 방식*의 차이로 봐도 될 듯.
